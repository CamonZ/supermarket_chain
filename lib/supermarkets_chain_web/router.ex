defmodule SupermarketsChainWeb.Router do
  ...
  # scope "/api", SupermarketsChainWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard in development
  if Application.compile_env(:supermarkets_chain, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SupermarketsChainWeb.Telemetry
    end
  end
end
